...
func init() {
	...
	utilruntime.Must(apolloadamswanglincomv1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "4d1695c2.adamswanglin.com",
	...
	configStore := apollosync.NewConfigStore(mgr.GetClient())
	if err = (&controller.ApolloConfigServerReconciler{
		Client:      mgr.GetClient(),
		Scheme:      mgr.GetScheme(),
		ConfigStore: configStore,
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "ApolloConfigServer")
		os.Exit(1)
	}
	if err = (&controller.ApolloConfigReconciler{
		Client:      mgr.GetClient(),
		Scheme:      mgr.GetScheme(),
		ConfigStore: configStore,
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "ApolloConfig")
		os.Exit(1)
	}
