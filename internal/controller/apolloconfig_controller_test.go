...
var _ = Describe("ApolloConfig Controller", func() {
	Context("When reconciling a resource", func() {
		...
		BeforeEach(func() {
			By("creating the custom resource for the Kind ApolloConfig")
			err := k8sClient.Get(ctx, typeNamespacedName, apolloconfig)
		...
		AfterEach(func() {
			...
			By("Cleanup the specific resource instance ApolloConfig")
